...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.jsp">Restaurantly</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.jsp" class="logo me-auto me-lg-0"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      ...
      <a href="login.jsp" class="book-a-table-btn scrollto d-none d-lg-flex">Login</a>
      </c:if>
      <c:if test="${sessionScope.account != null}">
        <a href="/logout" class="book-a-table-btn scrollto d-none d-lg-flex">Logout</a>
      </c:if>
    </div>
  </header><!-- End Header -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="about-img">
              <img src="Restaurantly/assets/img/about.jpg" alt="">
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
              ...
              <ul >
                <li data-filter="*" class="filter-active"><c:if test="${sessionScope.account.id_role==1}"><a type="button" href="/createProduct.jsp"> Create</a></c:if></li>
              </ul>
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <c:if test="${sessionScope.account.id_role==1}">
            <div> <td><a type="button" class="btn btn-danger" href="/edit?id=${p.id}">Edit</a></td>
              <td><a type="button" class="btn btn-success" href="/DeleteProductServlet?id=${p.id}">Delete</a></td></div>
            </c:if>
            <c:if test="${sessionScope.account.id_role==2}">
              <div> <td><a type="button" class="btn btn-success" href="/cart?id=${p.id}">Add to cart</a></td></div>
            </c:if>
        </div>
          </c:forEach>
